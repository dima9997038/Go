...
//    public static boolean gameOver(ClientHandler clientHandler){
//        boolean res=true;
//        int [][] copy_grid=grid;
//        int color = Server.players.get(clientHandler);
//        for (int col = 0; col <10 ; col++) {
//            for (int row = 0; row <10 ; row++) {
//                grid[col][row] =color;
//                deleteBols();
//                res=res&&!copy_grid.equals(grid); // deletBols сработал
//                grid=copy_grid;
//            }
//
//        }
//
//        System.out.println("gameOver message  "+res);
//        return  res;
//    }
